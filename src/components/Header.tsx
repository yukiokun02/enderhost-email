...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 py-3 px-4 sm:px-6 z-40 backdrop-blur-sm bg-black/30 animate-fade-in">
      ...
      {/* Floating Action Buttons - Fixed position at bottom right with proper spacing */}
